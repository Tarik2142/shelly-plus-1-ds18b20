...
Конфіг esphome доступний в каталогу /esphome_config<br>

На початку компіляції виберіть "Manual download"<br>
<img src="./img/manual_download.jpg?raw=true" width=650px/><br>
В кінці компіляції виберіть "OTA format"<br>
<img src="./img/ota_format.jpg?raw=true" width=650px/><br>
